export const biases_ru = {
    ...
    cognitiveBiases: {
        ...
        biases: [
            ...
            {
                categories: ["social", "memory", "politics", "belief"],
            ...
            },
            {
                ...
                example: "Единственная причина почему Мкасим помогает мне это то что он хочет меня что-то попросить для него сдлеать."
            },
            {
